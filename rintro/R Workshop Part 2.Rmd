...
ggplot(order_biomass, aes(Site, total_biomass)) +
  geom_boxplot() # change the plot type to boxplot where it will take all the points within a site and find the median, lower and upper hinges correspond to the first and third quartiles (the 25th and 75th percentiles)
...
order_plot +
  ...
  theme(axis.title = element_text(size = 14), # theme can be used to nest many different functions around the axes, legend, background
        axis.text.x = element_text(angle = 90)) # change the text angle for the x axis
